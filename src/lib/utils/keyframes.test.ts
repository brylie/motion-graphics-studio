...
describe('keyframes utilities', () => {
	describe('clampTimeToAdjacentKeyframes', () => {
		it('should clamp time between neighbors', () => {
			...
			const clampedLeft = clampTimeToAdjacentKeyframes(
				0.5,
				keyframes,
				1,
				constraints
			...
			const clampedRight = clampTimeToAdjacentKeyframes(
				3.99,
				keyframes,
				1,
				constraints
		...
		it('should respect clip boundaries for first keyframe', () => {
			...
			const clamped = clampTimeToAdjacentKeyframes(
				-1,
				keyframes,
				0,
				constraints
		...
		it('should apply snap grid', () => {
			...
			const snapped = clampTimeToAdjacentKeyframes(
				1.23,
				keyframes,
				0,
				constraints
